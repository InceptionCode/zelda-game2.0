...
export default class Intro extends Component {
  ...
  render() {
    const blinker = this.props.userName !== '' ? { animation: 'none' } : {},
      enterOption =
        this.props.userName !== ''
          ? {
              display: 'initial',
    ...
    return (
      <div>
        <div className="intro-section" style={this.props.divStyle}>
          <img src="../images/zelda-icon.jpg" className="intro-icon" />
          ...
          <p>
            {' '}
            Here at the edge of the Earth, rests a Hero. The time now is 10:30
            AM, as Link wakes up slowly from a long awaited sleep.
            <br />
            ...
            *BANG*
            ...
            danger.
            <br />
            He rolls out of bed, snatches his sword up off the wall with one
            hand. Then points his sword inches away from the figure's nose.
            <br />
            ...
            locked away. And only you can determine her fate. And this time
          ...
          <ul className="rules">
            <li>
              ...
              scenario. You luckily have two options to go with, so choose
              wisely.
              <br />
              This game utilizes the equipment you have in order to make your
              decision. Example: "Link has a choice, go take a knife or his
              sword. What will he do."
              <br />
              1. Take Knife.
              <br />
              2. Take Sword.
            ...
            <li>
              ...
              you use an item you LOSE it. That means it will NOT be available
              to use in the next scenario.
            </li>
            <li>
              If you fail to make the right move you will lose 25% health. Of
              course, if you are out of health... or out of equipment... well
              you know "Game Over"
            </li>
          </ul>
          <input
            ...
            style={blinker}
            onKeyDown={this.props.enterGame}
          />
